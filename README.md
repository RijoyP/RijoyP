...
│  Deployment  │
└──────────────┘
Pipeline Files: eShopMicroservices/.pipeline
...
🔗 Repository Links
Repository	Purpose
eShopMicroservices	Microservices source code
GitOps	Kubernetes manifests and FluxCD configs
terraform-modules	Infrastructure as Code modules
CICD-Templates	Reusable pipeline templates
helm-templates	Helm chart boilerplate
...
🚀 Deployment Summary
Infrastructure: Terraform provisions Azure resources (AKS, ACR, databases)
Platform: FluxCD deploys infrastructure components (logging, monitoring, messaging)
Applications: CI/CD builds images, updates GitOps repo, FluxCD auto-deploys to AKS
Monitoring: Observability stack provides full system visibility
